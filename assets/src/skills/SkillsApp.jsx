...
export default function SkillsApp() {
  ...
  return (
    <div className="albert-page albert-page--full albert-skills">
        ...
        <div className="albert-page__text">
          ...
          {!isLoading && (
            <div className="albert-skills__summary-row">
              <p className="albert-skills__summary" aria-live="polite">
                <span>
      ...
      {error && (
        <div className="albert-skills__error notice notice-error" role="alert">
          <p>{error}</p>
        </div>
      )}
      ...
      {isLoading ? (
        ...
        <p className="albert-hint albert-hint--info">
          {__("No skills are registered on this site.", "albert-ai-butler")}
        </p>
      ) : (
        <div
        ...
        >
          ...
          >
            <Toolbar view={view} onChangeView={setView} sources={sources} />
            <DataViews.Layout />
            <DataViews.Footer />
          </DataViews>
        </div>
      ...
      {openItem && <SkillFlyIn skill={openItem} onClose={onCloseFlyIn} />}
    </div>
  );
}
