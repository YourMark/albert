...
class SchemaPreparer {
	...
	public function register_hooks(): void {
		add_filter( 'mcp_adapter_tools_list', [ $this, 'prepare_tools_list' ], 20 );
		add_filter( 'mcp_adapter_tool_call_result', [ $this, 'prepare_ability_info_result' ], 10, 3 );
	}
	 ...
	 * @since 1.4.0
	 */
	public function prepare_tools_list( $tools ) {
	 ...
	 * normalised to pure arrays. Already-array schemas (e.g. from
	 * get-ability-info) pass through the normalisation unchanged.
	 *
	...
	private function prepare_schema( array $schema ): array {
		$normalised = json_decode( (string) wp_json_encode( $schema ), true );
	 ...
	 * @since 1.4.0
	 */
	public function prepare_ability_info_result( $result, $args, string $tool_name ) {
