...
class PiiPolicy {
	...
	public static function redact( array $data, array $args = [], array $opts = [] ): array {
		...
		} elseif ( self::allows_reveal( $args, $mode ) ) {
	 ...
	 * @return bool
	 */
	public static function allows_reveal( array $args, PrivacyMode $mode ): bool {
		 ...
		 * @since 1.3.0
		 *
		 * @param string $capability The gating capability (default `manage_woocommerce`).
		 */
		$capability = apply_filters( 'albert/privacy/reveal_capability', 'manage_woocommerce' );
